...
export class SignInService {
  ...
  private authUrl = 'http://user-service.app.svc.cluster.local:32252/api/v1/users/auth'; 
  ...
  private checkEnabeledUrl='http://user-service.app.svc.cluster.local:32252/api/v1/users/auth';
