...
export class SignInService {
  ...
  private authUrl = 'http://user-service.app.svc.cluster.local:8080/api/v1/users/auth'; 
  ...
  private checkEnabeledUrl='http://user-service.app.svc.cluster.local:8080/api/v1/users/auth';
